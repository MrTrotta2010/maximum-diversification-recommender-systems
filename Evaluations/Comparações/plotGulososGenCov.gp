...
set xlabel "Usuários (%)" 
plot inputGuloso using ((column(0) / users) * 100):4 title titleGuloso with line lw 10 lc "yellow",\
    inputGulosoNaive using ((column(0) / users) * 100):4 title titleGulosoNaive with line lw 10 lc "green",\
