...
set xlabel "Usuários (%)" 
plot inputPSO using ((column(0) / 6040) * 100):3 title titlePSO with line lw 10 lc "red",\
    inputITS using ((column(0) / 6040) * 100):3 title titleITS with line lw 10 lc "blue",\
    inputGuloso using ((column(0) / 6040) * 100):3 title titleGuloso with line lw 10 lc "yellow",\
