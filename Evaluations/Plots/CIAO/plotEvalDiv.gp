...
set xlabel "Usuários (%)" 
plot inputMDRS using ((column(0) / 7630) * 100):4 title titleMDRS with line lw 10 lc "#000000",\
    inputStandard using ((column(0) / 7630) * 100):4 title titleStandard with line lw 10 lc "red",\
