...
set xlabel "Usuários (%)" 
plot "../../MDRS_Output/CIAO/alfa0.250000/userKNN/acc.txt" using ((column(0) / 7630) * 100):2 title "" with line lw 10 lc "#000000",\
...
set xlabel "Usuários (%)" 
plot "../../MDRS_Output/CIAO/alfa0.250000/userKNN/div.txt" using ((column(0) / 7630) * 100):4 title "" with line lw 10 lc "#000000",\
