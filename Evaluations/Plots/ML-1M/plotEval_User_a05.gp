...
set xlabel "Usuários (%)" 
plot "../../MDRS_Output/ML-1M/alfa0.500000/userKNN/acc.txt" using ((column(0) / 6040) * 100):2 title "" with line lw 10 lc "#000000",\
...
set xlabel "Usuários (%)" 
plot "../../MDRS_Output/ML-1M/alfa0.500000/userKNN/div.txt" using ((column(0) / 6040) * 100):4 title "" with line lw 10 lc "#000000",\
