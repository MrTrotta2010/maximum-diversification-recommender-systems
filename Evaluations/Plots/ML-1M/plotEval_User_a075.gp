...
set xlabel "Usuários (%)" 
plot "../../MDRS_Output/ML-1M/alfa0.750000/userKNN/acc.txt" using ((column(0) / 6040) * 100):2 title "" with line lw 10 lc "#000000",\
    "../../Standard/ML-1M/userKNN/acc.txt" using ((column(0) / 6040) * 100):2 title "" with line lw 10 lc "red",\


set output "../../Results/UserKNN/ML-1M/div.eps"		#nome de saida
set ylabel "Diversidade" offset 1
set xlabel "Usuários (%)" 
plot "../../MDRS_Output/ML-1M/alfa0.750000/userKNN/div.txt" using ((column(0) / 6040) * 100):4 title "" with line lw 10 lc "#000000",\
