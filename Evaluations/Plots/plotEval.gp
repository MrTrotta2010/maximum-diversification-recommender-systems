...
#nome de saida
set ylabel metric offset 1
set xlabel "Usuários (%)" 
plot inputMDRS using ((column(0) / 6040) * 100):collumn title titleMDRS with line lw 10 lc "#000000",\
    inputStandard using ((column(0) / 6040) * 100):collumn title titleStandard with line lw 10 lc "red",\
