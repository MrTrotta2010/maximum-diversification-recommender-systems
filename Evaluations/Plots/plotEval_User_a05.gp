...
set xlabel "Usuários (%)" 
plot "../MDRS_Output/ML-1M/alfa0.500000/userKNN/acc.txt" using ((column(0) / 6040) * 100):2 title "MDRS a=0.5" with line lw 10 lc "#000000",\
...
set xlabel "Usuários (%)" 
plot "../MDRS_Output/ML-1M/alfa0.500000/userKNN/acc_Rel.txt" using ((column(0) / 6040) * 100):3 title "MDRS a=0.5" with line lw 10 lc "#000000",\
...
set xlabel "Usuários (%)" 
plot "../MDRS_Output/ML-1M/alfa0.500000/userKNN/div.txt" using ((column(0) / 6040) * 100):4 title "MDRS a=0.5" with line lw 10 lc "#000000",\
...
set ylabel "Diversidade" offset 1
set xlabel "Usuários (%)" 
plot "../MDRS_Output/ML-1M/alfa0.500000/userKNN/div_rel.txt" using ((column(0) / 6040) * 100):5 title "MDRS a=0.5" with line lw 10 lc "#000000",\
