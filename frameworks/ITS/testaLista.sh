...
do	
    ...
    mkdir ../../Evaluations/ITS_Output/CIAO/alfa0.5/testesTabu/userKNN$t
   	...
   	./its ITS ../../Datasets/CIAO/ ../../Recommendations-Lists/ML-1M/rec_userKNN_conv.txt ../../Evaluations/ITS_Output/CIAO/alfa0.5/testesTabu/userKNN$t 100 0.5 10 85 $t
done
